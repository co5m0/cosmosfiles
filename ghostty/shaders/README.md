...
- [thunder_cursor.glsl](thunder_cursor.glsl): Lightning bolt effect triggering on cursor movement
- [sparks_cursor.glsl](sparks_cursor.glsl): Particle sparks explosion on cursor movement
